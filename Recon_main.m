...
folderPath_data     = 'C:\Users\ECE-chowdhury-lab\Downloads\codes\codes'; % Specify the folder path here
folderPath_function = 'C:\Users\ECE-chowdhury-lab\Downloads\codes\codes'; % Specify the folder path here
...
% Please select a sample to reconstruct (options: 40um_phantom, 60um_phantom, 80um_phantom, 100um_phantom, celegans, zebrafish_embryo, organoid)
% For example : sample_name = 'zebrafish_embryo';

sample_type = 'zebrafish_embryo';     
...
switch sample_type
    ...
    case '40um_phantom'
        load('040um_phantom_data.mat');

    case '60um_phantom'
        load('060um_phantom_data.mat');

    case '80um_phantom'
        load('080um_phantom_data.mat');

    case '100um_phantom'
        load('100um_phantom_data.mat');
...
refocusing     = true;                 % TRUE: use digitally refoucsed amplitude data; FALSE: use amplitude measurement only from imaging plane
